# -*- coding: utf-8 -*-
"""
Created on Thu Dec 14 08:33:17 2023
...
progress = 0
max_attempts = 5
start_index=[1,12,121,522,1422]
end_index=[11,120,521,1421,2400]
...
def ask_question(question):
    print("What is the product of", question[0], "and", question[1], "?")
...
def main(math_score,age):
    ...
    while progress < 5:
        ...
        while attempts < max_attempts:
            ...
            if user_answer == 'quit':
                print("Your multiplication score:", math_score, "!!!")
                return math_score
            
            p= evaluate_answer(user_answer,int( current_question[4]),math_score)
            if(p):
                math_score=p
                break
            else:
