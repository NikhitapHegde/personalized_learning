# -*- coding: utf-8 -*-
"""
Created on Thu Dec 14 08:42:22 2023
...
def ask_question(question):
    print("What is the quoient of", question[0], "and", question[1], "?")
...
def main(math_score,age):
    ...
    while progress < 5:
        ...
        while attempts < max_attempts:
            ...
            p= evaluate_answer(user_answer,int( current_question[5]),math_score)
            if(p):
                math_score=p
                break
            else:
